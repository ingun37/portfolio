...
export function GraphicsProjects() {
    const games: ProjectProp[] = [
        new ProjectProp("Implementation of 3D Model animation system using native graphics library (Metal/C++)", animation, null, "2015", null, undefined, "https://github.com/ingun37/sujak"),
        new ProjectProp("Implementation of Deferred Rendering using native graphics library (OpenGL/C++)", deferred, null, "2014", null, undefined, "https://ingun37.wordpress.com/2015/03/30/deferred-shading/"),
